...
public interface TableColumnModelListener extends EventListener {
    ...
    /**
     * Invoked when a <code>TableColumn</code> is added to the model.
     *
    ...
    /**
     * Invoked when a <code>TableColumn</code> is moved within the model.
     *
     * @param e the <code>TableColumnModelEvent</code> describing the update
     */
    ...
    /**
     * Invoked when a <code>TableColumn</code> is removed from the model.
     *
     * @param e the <code>TableColumnModelEvent</code> describing the update
     */
