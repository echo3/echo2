...
public abstract class AbstractButton extends Component {
     ...
     * component instance.
     */
    private class EventForwarder implements ActionListener, ChangeListener {
    ...
    /**
     * <code>EventForwarder</code> instance.
     */
    ...
    public void setModel(ButtonModel newValue) {
        ...
        if (oldValue != null) {
            oldValue.removeActionListener(eventForwarder);
            oldValue.removeChangeListener(eventForwarder);
        }

        newValue.addActionListener(eventForwarder);
        newValue.addChangeListener(eventForwarder);
