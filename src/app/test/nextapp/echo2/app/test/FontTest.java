...
/**
 * Unit test(s) for the <code>nextapp.echo2.app.Font</code> property 
 * value object.
 */
public class FontTest extends TestCase {
    ...
    public void testToString() {
        ...
        assertEquals("nextapp.echo2.app.Font (Sans-Serif / Plain / 12pt)", font.toString());
        
        font = new Font(Font.VERDANA, Font.PLAIN, new Extent(12, Extent.PT));
        assertEquals("nextapp.echo2.app.Font (Verdana, Arial, Helvetica, Sans-Serif / Plain / 12pt)", font.toString());
        
        font = new Font(Font.TIMES_NEW_ROMAN, Font.BOLD | Font.ITALIC | Font.UNDERLINE, new Extent(24, Extent.PX));
        assertEquals("nextapp.echo2.app.Font (Times New Roman, Times Roman, Times, Serif / Bold Italic Underline / 24px)", 
                font.toString());
        ...
        assertEquals("nextapp.echo2.app.Font (Sans-Serif / Bold Italic LineThrough Overline Underline / 12pt)", font.toString());
    }
