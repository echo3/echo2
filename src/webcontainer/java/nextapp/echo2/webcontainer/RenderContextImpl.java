...
implements RenderContext {
    ...
    /**
     * Creates a new <code>RenderContextImpl</code> containing a new
     * <code>ServerMessage</code> based on the given <code>Connection</code>.
     * 
     * @param conn the <code>Connection</code> 
     */
    RenderContextImpl(Connection conn) {
        super();
        this.conn = conn;
        serverMessage = new ServerMessage(conn.getUserInstance().getApplicationUri());
    }
